package com.ycc.customer1.customer1.http;
...
// httpClient 4.5以上版本 SSLContextBuilder从原来的org.apache.http.conn.ssl 包挪到了org.apache.http.ssl 包
...
public class HttpClientUtils {
	...
	public static String sendHttpGet(String httpUrl, Map<String, String> params) {
		if (params != null && params.size() > 0) {
			String data = convertStringParamter(params);
	...
	public static void main(String[] args) throws Exception {
		...
		String s = HttpClientUtils.sendHttpPostJson("http://localhost:8082/activity/getName", jsonArray.toJSONString());
